 ...
 */
function ExampleBpmnJsExtension(eventBus,bpmnjs, canvas, elementRegistry, modeling) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  ADDED_LOGGER: ['type', _ExampleBpmnJsExtension__WEBPACK_IMPORTED_MODULE_0__["default"] ]
});

/***/ }),

/***/ "./client/test-extension/ReducedPalettePlugin.js":
/*!*******************************************************!*\
  !*** ./client/test-extension/ReducedPalettePlugin.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ReducedPalettePlugin)
/* harmony export */ });
/* harmony import */ var _custom_CustomContextPadProvider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./custom/CustomContextPadProvider */ "./client/test-extension/custom/CustomContextPadProvider.js");
/* harmony import */ var _custom_CustomPaletteProvider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./custom/CustomPaletteProvider */ "./client/test-extension/custom/CustomPaletteProvider.js");
/* harmony import */ var _custom_CustomReplaceMenuProvider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./custom/CustomReplaceMenuProvider */ "./client/test-extension/custom/CustomReplaceMenuProvider.js");
...
function ReducedPalettePlugin(bpmnjs, contextPad, palette, create, elementFactory, spaceTool, lassoTool, handTool, globalConnect, translate, eventBus, modeling, connect, popupMenu, canvas, rules, bpmnReplace, moddle, replaceMenuProvider) {
    ...
    console.log(_custom_CustomContextPadProvider__WEBPACK_IMPORTED_MODULE_0__["default"])
    var customContextPad = new _custom_CustomContextPadProvider__WEBPACK_IMPORTED_MODULE_0__["default"](eventBus, contextPad, modeling, elementFactory, connect, create, popupMenu, canvas, rules, translate);
    contextPad._providers = [];
    contextPad.registerProvider(customContextPad);

    var customPalette = new _custom_CustomPaletteProvider__WEBPACK_IMPORTED_MODULE_1__["default"](palette, create, elementFactory, spaceTool, lassoTool, handTool, globalConnect, translate);
    palette._providers = [];
    palette.registerProvider(customPalette);

    var customReplaceMenu = new _custom_CustomReplaceMenuProvider__WEBPACK_IMPORTED_MODULE_2__["default"](popupMenu, modeling, moddle, bpmnReplace, rules, translate);
...
/***/ "./client/test-extension/custom/CustomContextPadProvider.js":
/*!******************************************************************!*\
  !*** ./client/test-extension/custom/CustomContextPadProvider.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var bpmn_js_lib_features_context_pad_ContextPadProvider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! bpmn-js/lib/features/context-pad/ContextPadProvider */ "./node_modules/bpmn-js/lib/features/context-pad/ContextPadProvider.js");
...
function CustomContextPadProvider(eventBus, contextPad, modeling, elementFactory, connect, create, popupMenu, canvas, rules, translate) {
  ...
  bpmn_js_lib_features_context_pad_ContextPadProvider__WEBPACK_IMPORTED_MODULE_1__["default"].call(this, eventBus, contextPad, modeling, elementFactory, connect, create, popupMenu, canvas, rules, translate);

  var cached = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.bind)(this.getContextPadEntries, this);
...
console.log(bpmn_js_lib_features_context_pad_ContextPadProvider__WEBPACK_IMPORTED_MODULE_1__["default"])
console.log(CustomContextPadProvider)

;(0,inherits_browser__WEBPACK_IMPORTED_MODULE_2__["default"])(CustomContextPadProvider, bpmn_js_lib_features_context_pad_ContextPadProvider__WEBPACK_IMPORTED_MODULE_1__["default"]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CustomContextPadProvider);

/***/ }),

/***/ "./client/test-extension/custom/CustomPaletteProvider.js":
/*!***************************************************************!*\
  !*** ./client/test-extension/custom/CustomPaletteProvider.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
PaletteProvider.prototype.getPaletteEntries = function(element) {
  ...
  function createAction(type, group, className, title, options) {
    ...
    function createListener(event) {
      var shape = elementFactory.createShape((0,lodash__WEBPACK_IMPORTED_MODULE_0__.assign)({ type: type }, options));
  ...
  (0,lodash__WEBPACK_IMPORTED_MODULE_0__.assign)(actions, {
    'hand-tool': {
      group: 'tools',
...
/***/ "./client/test-extension/custom/CustomReplaceMenuProvider.js":
/*!*******************************************************************!*\
  !*** ./client/test-extension/custom/CustomReplaceMenuProvider.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var bpmn_js_lib_features_popup_menu_ReplaceMenuProvider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bpmn-js/lib/features/popup-menu/ReplaceMenuProvider */ "./node_modules/bpmn-js/lib/features/popup-menu/ReplaceMenuProvider.js");
...
function CustomReplaceMenuProvider(popupMenu, modeling, moddle, bpmnReplace, rules, translate) {
  bpmn_js_lib_features_popup_menu_ReplaceMenuProvider__WEBPACK_IMPORTED_MODULE_0__["default"].call(this, popupMenu, modeling, moddle, bpmnReplace, rules, translate);
};

console.log(CustomReplaceMenuProvider)
console.log(bpmn_js_lib_features_popup_menu_ReplaceMenuProvider__WEBPACK_IMPORTED_MODULE_0__["default"])
;(0,inherits_browser__WEBPACK_IMPORTED_MODULE_1__["default"])(CustomReplaceMenuProvider, bpmn_js_lib_features_popup_menu_ReplaceMenuProvider__WEBPACK_IMPORTED_MODULE_0__["default"]);

CustomReplaceMenuProvider.prototype._createEntries = function(element, replaceOptions) {
  var options = bpmn_js_lib_features_popup_menu_ReplaceMenuProvider__WEBPACK_IMPORTED_MODULE_0__["default"].prototype._createEntries.call(this, element, replaceOptions);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CustomReplaceMenuProvider);

/***/ }),

/***/ "./client/test-extension/index.js":
/*!****************************************!*\
  !*** ./client/test-extension/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ReducedPalettePlugin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ReducedPalettePlugin */ "./client/test-extension/ReducedPalettePlugin.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  __init__: [ 'PLATTE' ],
  PLATTE: ['type', _ReducedPalettePlugin__WEBPACK_IMPORTED_MODULE_0__["default"] ]
});
...
ContextPadProvider.prototype.getContextPadEntries = function(element) {
  ...
  if ((0,_modeling_util_ModelingUtil__WEBPACK_IMPORTED_MODULE_2__.isAny)(businessObject, [ 'bpmn:Lane', 'bpmn:Participant' ]) && (0,_util_DiUtil__WEBPACK_IMPORTED_MODULE_3__.isExpanded)(element)) {
    ...
    if (childLanes.length < 2) {
      ...
      if ((0,_util_DiUtil__WEBPACK_IMPORTED_MODULE_3__.isHorizontal)(element) ? element.height >= 120 : element.width >= 120) {
        (0,min_dash__WEBPACK_IMPORTED_MODULE_1__.assign)(actions, {
          'lane-divide-two': {
            group: 'lane-divide',
      ...
      if ((0,_util_DiUtil__WEBPACK_IMPORTED_MODULE_3__.isHorizontal)(element) ? element.height >= 180 : element.width >= 180) {
        (0,min_dash__WEBPACK_IMPORTED_MODULE_1__.assign)(actions, {
          'lane-divide-three': {
            group: 'lane-divide',
...
"use strict";
module.exports = JSON.parse('{"name":"Elmi","prefix":"elmi","uri":"http://example.com/elmi","xml":{"tagAlias":"lowerCase"},"associations":[],"types":[{"name":"CustomTask","superClass":["bpmn:Task"]}]}');
...
/* harmony import */ var _bpmn_js_extension__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bpmn-js-extension */ "./client/bpmn-js-extension/index.js");
/* harmony import */ var _test_extension__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./test-extension */ "./client/test-extension/index.js");
/** 
...
(0,camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__.registerBpmnJSModdleExtension)(_resources_qa_json__WEBPACK_IMPORTED_MODULE_1__);



(0,camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__.registerBpmnJSPlugin)(_bpmn_js_extension__WEBPACK_IMPORTED_MODULE_2__["default"]);



(0,camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__.registerBpmnJSPlugin)(_test_extension__WEBPACK_IMPORTED_MODULE_3__["default"]);
})();
