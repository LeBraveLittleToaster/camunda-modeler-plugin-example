...
import ExampleBpmnJsExtension from '../client/bpmn-js-extension/ExampleBpmnJsExtension';
...
export default {
  __init__: [ 'PLEASE_CHANGE_ME2' ],
  PLEASE_CHANGE_ME2: ['type', ExampleBpmnJsExtension ]
};
